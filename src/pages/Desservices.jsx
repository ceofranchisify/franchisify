...
const FranchiseServices = () => {
  return (
    <section className="bg-gradient-to-r from-[#83C4E3] to-[#5A9EC2] text-white py-16 px-6 pt-24">
      <div className="max-w-5xl mx-auto space-y-16">
        
        {/* Franchise Model Development Section */}
        <div className="text-center">
          <FaBusinessTime className="text-blue-500 text-6xl mx-auto mb-6" />
        ...
        <div className="text-center">
          <FaBalanceScale className="text-blue-500 text-6xl mx-auto mb-6" />
        ...
        <div className="text-center">
          <FaBullhorn className="text-blue-500 text-6xl mx-auto mb-6" />

  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-12">
      <div className="max-w-4xl w-full bg-white shadow-2xl rounded-2xl p-8 md:p-12">
        ...
        <p className="text-sm text-gray-500 mb-8">Effective Date: 16-04-2025</p>
        ...
        <div className="space-y-8 text-gray-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-2">3. Franchise Information Disclaimer</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-2">4. User-Submitted Content</h2>
            <p>
          ...
          <section>
            ...
            <div className="bg-gray-100 p-4 rounded-lg mt-3 text-sm md:text-base">

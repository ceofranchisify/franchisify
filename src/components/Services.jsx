        ...
        <div className="grid gap-12 mt-12 sm:grid-cols-2 lg:grid-cols-4">
          {services.map((service, index) => (
            ...
            >
              ...
              <p className="mt-4 text-black leading-relaxed">{service.description}</p>
              <button
                onClick={() => handleLearnMore(service.id)} // Pass the section ID
                className="mt-6 px-5 py-2 bg-blue-600 text-black font-semibold rounded-lg transition duration-300 hover:bg-blue-500"
              >
                Learn More
              </button>
            </motion.div>

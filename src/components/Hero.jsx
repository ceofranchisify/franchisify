  ...
  return (
    <div className="relative overflow-hidden text-white">
      ...
      <div className="relative min-h-screen flex flex-col lg:flex-row items-center justify-between px-6 sm:px-10 lg:px-24 py-16 sm:py-20 bg-gradient-to-r from-[#83C4E3] to-[#5A9EC2]">
        ...
        >
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#ffaa00] to-[#000000] leading-tight">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-orange-500 text-white px-6 sm:px-8 py-3 rounded-full font-semibold text-lg shadow-md hover:shadow-orange-500/50"
            >
              Get Started 🚀
            </motion.button>
            <motion.button
              whileHover={{ scale: 1.1 }}
              whileTap={{ scale: 0.95 }}
              className="border-2 border-orange-500 text-orange-400 px-6 sm:px-8 py-3 rounded-full font-semibold text-lg shadow-md hover:bg-orange-500 hover:text-white transition"
            >
              Learn More
            </motion.button>
          </div>
      ...
      <div className="py-16 px-6 sm:px-10 text-white grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-16 items-center">
        {/* Mission Section */}
        <motion.div
          className="bg-[#1E293B] p-8 sm:p-10 rounded-3xl shadow-xl border border-cyan-500/30 backdrop-blur-md"
          initial={{ opacity: 0, x: -50 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.8 }}
        >
...
To create a sustainable ecosystem where franchisors and franchisees thrive together and introduce you to seamless and structured expansion plans. 
        ...
        />
        <motion.div
          className="bg-[#1E293B] p-8 sm:p-10 rounded-3xl shadow-xl border border-purple-500/30 backdrop-blur-md"
          initial={{ opacity: 0, x: 50 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.8 }}
        >
